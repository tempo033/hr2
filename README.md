...
تم استكمال إصلاح مسارات المرشحين والموظفين والمباشرة والاعتمادات والمستخدمين لضمان استمرار العمل مع جلسة المستخدم وRLS.

تم تثبيت مفتاح fallback في طبقة المصادقة المشتركة حتى تعمل جميع واجهات البيانات بنفس إعداد تسجيل الدخول.
