...
import { BriefcaseBusiness, GraduationCap, ClipboardCheck, UserRoundCheck, ArrowLeft, Users, FilePlus2, UserCheck, UserPlus, Layers, FileText } from 'lucide-react';
...
export default function Home() {
  return (
    <main className="app-shell flex">
      <aside className="sidebar hidden md:flex flex-col p-6">
        <div className="text-2xl font-bold">البنية الاساسية</div>
        <div className="text-sm text-slate-300 mt-1">للمقاولات</div>
        <nav className="mt-10 space-y-1.5">
          <Link className="block rounded-xl bg-white/10 px-4 py-2.5 font-bold" href="/">الرئيسية</Link>
          <Link className="block rounded-xl px-4 py-2.5 hover:bg-white/10 text-sm" href="/requests">طلبات الموارد البشرية</Link>
          <Link className="block rounded-xl px-4 py-2.5 hover:bg-white/10 text-sm" href="/forms/unified">النماذج الموحدة (مباشرة وعرض)</Link>
          <Link className="block rounded-xl px-4 py-2.5 hover:bg-white/10 text-sm" href="/interviews">المقابلة والتقييم الهرمي</Link>
          <Link className="block rounded-xl px-4 py-2.5 hover:bg-white/10 text-sm" href="/offers">العروض الوظيفية والتوقيع</Link>
          <Link className="block rounded-xl px-4 py-2.5 hover:bg-white/10 text-sm" href="/hiring-approvals">اعتماد التعيين</Link>
          <Link className="block rounded-xl px-4 py-2.5 hover:bg-white/10 text-sm" href="/onboarding">مباشرة العمل وملف الموظف</Link>
          <Link className="block rounded-xl px-4 py-2.5 hover:bg-white/10 text-sm" href="/forms">مركز النماذج</Link>
          <Link className="block rounded-xl px-4 py-2.5 hover:bg-white/10 text-sm" href="/employees">ملفات الموظفين</Link>
        </nav>
      </aside>
          ...
          <div className="grid md:grid-cols-2 gap-5 mt-8">
            <Link href="/forms/unified" className="card p-6 flex flex-col md:flex-row justify-between gap-4 items-center border-2 border-[#b88618] bg-amber-50/30 hover:-translate-y-0.5 transition rounded-2xl">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-xl bg-[#b88618] text-white flex items-center justify-center shrink-0">
                  <Layers size={24} />
                </div>
                <div>
              ...
              <span className="btn-gold rounded-xl px-5 py-3 font-bold flex items-center gap-2 text-sm shrink-0">
                فتح النماذج <ArrowLeft size={17} />
              </span>
            </Link>
            ...
            <Link href="/interviews" className="card p-6 flex flex-col md:flex-row justify-between gap-4 items-center border-2 border-[#09233f]/20 hover:-translate-y-0.5 transition rounded-2xl bg-white">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-xl bg-[#09233f] text-[#d4a72c] flex items-center justify-center shrink-0">
              ...
              <span className="btn-primary rounded-xl px-5 py-3 font-bold flex items-center gap-2 text-sm shrink-0">
                المقابلات <ArrowLeft size={17} />
              </span>
            </Link>
            ...
            <Link href="/offers" className="card p-6 flex flex-col md:flex-row justify-between gap-4 items-center border-2 border-green-200 hover:-translate-y-0.5 transition rounded-2xl bg-white">
              ...
              <span className="rounded-xl px-5 py-3 font-bold flex items-center gap-2 bg-green-600 text-white text-sm shrink-0">
                العروض <ArrowLeft size={17} />
              </span>
            </Link>
            ...
            <Link href="/onboarding" className="card p-6 flex flex-col md:flex-row justify-between gap-4 items-center border-2 border-blue-200 hover:-translate-y-0.5 transition rounded-2xl bg-white">
              ...
              <span className="rounded-xl px-5 py-3 font-bold flex items-center gap-2 bg-blue-600 text-white text-sm shrink-0">
                المباشرة <ArrowLeft size={17} />
              </span>
            </Link>
          </div>
        </div>
